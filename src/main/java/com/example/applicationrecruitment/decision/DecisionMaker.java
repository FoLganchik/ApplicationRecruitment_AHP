package com.example.applicationrecruitment.decision;

import com.example.applicationrecruitment.MainApplication;
import com.example.applicationrecruitment.controller.DialogAskDecisionMaker;
...
public class DecisionMaker {
    public static double ask(String alternativeI, String alternativeJ, String criterionId) {
        ...
        try {
            ...
            loader.setLocation(MainApplication.class.getResource("/fxml-files/dialog_ask_decision_maker.fxml"));
