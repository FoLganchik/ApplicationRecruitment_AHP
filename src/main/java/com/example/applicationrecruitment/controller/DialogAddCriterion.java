...
public class DialogAddCriterion {
    ...
    private boolean isInputValid() {
        ...
        if( headRadioButton.isSelected() ){
            criterion.setParent(MainApplication.AHP.headId);
        }else{
            ...
            for( int i=0; i<parents.length; i++ ){
                ...
                }else if( MainApplication.AHP.alternatives.contains(parents[i]) ){
        ...
        if( alternativesRadioButton.isSelected() ){
            criterion.alternatives = MainApplication.AHP.alternatives;
        }else{
            ...
            for( int i=0; i<childrenCriterions.length; i++ ){
                ...
                }else if( MainApplication.AHP.alternatives.contains(childrenCriterions[i])){
